...
🔗 دموی زنده: `https://YOUR-USERNAME.github.io/YOUR-REPOSITORY/`

> این آدرس یک placeholder است — پس از فعال‌سازی GitHub Pages (بخش مربوطه در ادامه)، آن را با آدرس واقعی ریپازیتوری خودتان جایگزین کنید. همچنین می‌توانید یک دامنهٔ اختصاصی به آن متصل کنید.
